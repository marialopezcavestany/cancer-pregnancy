...
function dydt = cell_1_MCMechanism(t,y,kinetics)

%This function is in charge of outlining all of the reactions that 
%make up the STAT3/JAK2/JAG1 signaling pathway. This also includes
%the reaction kinetics and importing the initial values from the 
%Run File.
...
k21f = kinetics(32); k21r = kinetics(33);
...
k25_1 = kinetics(37); k25_2 = kinetics(38);
...
k30_1 = kinetics(43); k30_2 = kinetics(44);
